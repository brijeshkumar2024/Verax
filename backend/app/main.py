...
from app.engine.trigger_normalizer import normalize_trigger
...
def tick(payload: ComposeRequest) -> ComposeResponse:
    """
    Main compose decision endpoint. All fields optional with sensible defaults.
    ...
    try:
        ...
        payload.trigger.type = normalized_trigger  # type: ignore
