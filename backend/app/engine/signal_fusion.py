...
def fuse_signals(ctx: NormalizedContext, reference_time: datetime) -> FusedSignals:
    ...
    score = fatigue_score(ctx.merchant_id, reference_time)
    penalty = fatigue_penalty(ctx.merchant_id, reference_time)
